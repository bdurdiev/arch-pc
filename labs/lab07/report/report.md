...
![Программа в файле task-1.asm](image/12.png){ #fig:012 width=70%, height=70% }

![Запуск программы task-1.asm](image/13.png){ #fig:013 width=70%, height=70% }
...
![Программа в файле task-2.asm](image/14.png){ #fig:014 width=70%, height=70% }

![Запуск программы task-2.asm](image/15.png){ #fig:015 width=70%, height=70% }
